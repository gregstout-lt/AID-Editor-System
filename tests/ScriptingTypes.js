 ...
 * @property {string} [createdAt] Defined after creating a StoryCard using {@link addStoryCard}.
 * @property {string} [updatedAt] Defined after creating a StoryCard using {@link addStoryCard}.
 * @property {boolean} [useForCharacterCreation] Defined after creating a StoryCard using {@link addStoryCard}.
 */
/**
...
if (!globalThis.addStoryCard) {
   ...
   * @template {string} E
   * @template {string} T
   * @param {K} keys - This will set {@link StoryCard.keys} __and__ {@link StoryCard.title}.
   * @param {E} entry - This will set {@link StoryCard.entry}.
...
if (!globalThis.updateStoryCard) {
   ...
   * @param {K} keys - {@link StoryCard.keys}.
   * @param {E} entry - {@link StoryCard.entry}.
